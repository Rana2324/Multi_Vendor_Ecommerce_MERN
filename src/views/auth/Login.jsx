...
const Login = () => {
    ...
    return (
        <div className='min-w-screen min-h-screen bg-[#cdcae9] flex justify-center items-center'>
            <div className='w-[350px] text-[#ffffff] ps-2'>
                <div className='bg-[#6f68d1] p-4 rounded-t-md'>
                    <h2 className='text-xl mb-3 font-bold'>
                        Welcome to Ecommerce
                    </h2>
                    <p className='text-sm md-3 font-medium'>Please Sing In your account</p>

                    <form onSubmit={submit}>

                        <div className='flex flex-col w-full gap-1 md-3'>
                        ...
                        <div className='flex flex-col w-full gap-1 md-3 mb-3'>
                        ...
                        <div className='flex justify-center items-center gap-3'>
                            <div className='w-[135px] h-[35px] flex rounded-md bg-orange-700 hover:shadow-orange-700/50 justify-center cursor-pointer items-center overflow-hidden'>
                                <span><FaGoogle /></span>
                            </div>
                            <div className='w-[135px] h-[35px] flex rounded-md bg-blue-700 hover:shadow-blue-700/50 justify-center cursor-pointer items-center overflow-hidden'>
